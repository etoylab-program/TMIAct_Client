...
public BeforeRmiInvocationDelegate BeforeRmiInvocation = delegate(Nettention.Proud.BeforeRmiSummary summary) {};
		...
		public delegate bool ReqTempDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext);  
		public ReqTempDelegate ReqTemp = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext)
		{ 
			return false;
		};
	public override bool ProcessReceivedMessage(Nettention.Proud.ReceivedMessage pa, Object hostTag) 
	{
		...
		{
        case Common.ReqTemp:
            ProcessReceivedMessage_ReqTemp(__msg, pa, hostTag, remote);
            break;
		default:
			 goto __fail;
		}
...
__fail:
    ...
    void ProcessReceivedMessage_ReqTemp(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        ...
        core.PostCheckReadMessage(__msg, RmiName_ReqTemp);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
                NotifyCallFromStub(Common.ReqTemp, RmiName_ReqTemp,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.ReqTemp;
        summary.rmiName = RmiName_ReqTemp;
        ...
        // Call this method.
        bool __ret =ReqTemp (remote,ctx  );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_ReqTemp);
        }
