...
public class ActionBlackBlackhole2 : ActionSupporterSkillBase
{
	...
	public override void Init(int tableId, List<GameTable.CharacterSkillPassive.Param> listAddCharSkillParam)
	{
		...
		actionCommand = eActionCommand.BlackBlackhole2;
	}
	...
	public override void OnStart(IActionBaseParam param)
	{
		...
		mListPjt = m_owner.aniEvent.GetAllProjectile(eAnimation.Attack07);
		if (mListPjt.Count > 0)
		{
			mDuration = mListPjt[0].duration;

			m_owner.PlayAniImmediate(eAnimation.Attack07);
