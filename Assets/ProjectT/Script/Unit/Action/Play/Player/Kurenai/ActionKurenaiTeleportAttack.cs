...
public class ActionKurenaiTeleportAttack : ActionTeleport
{
    public enum eState
    {
        Start,
    ...
    public override void OnStart(IActionBaseParam param)
    {
        ...
        mDestPos = GetDestPos();
        Vector3 dir = (mDestPos - m_owner.transform.position).normalized;

        mMoveTime = m_aniLength;
        m_owner.StartStepForward(mMoveTime, mDestPos, EndStartState);
    }
    ...
    private void EndStartState()
    {
        ...
        m_owner.rigidBody.MovePosition(mDestPos);
