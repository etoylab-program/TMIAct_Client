...
public class ActionMurasakiEvadeDoubleAttack : ActionSelectSkillBase
{
    ...
    public override void Init(int tableId, List<GameTable.CharacterSkillPassive.Param> listAddCharSkillParam)
    {
        ...
        if (mValue1 >= 1.0f)
        {
            List<AniEvent.sEvent> list = m_owner.aniEvent.GetAllMeleeAttackEvent(eAnimation.EvadeDouble2);
