...
public class ActionSakuraRushAttack : ActionSelectSkillBase
{
    [Header("Property")]
    ...
    protected eAnimation m_curAni = eAnimation.RushAttack;
    ...
    public override void OnStart(IActionBaseParam param)
    {
        ...
        if(mValue1 <= 0.0f)
            m_curAni = eAnimation.RushAttack;
        else
            m_curAni = eAnimation.RushAttack2;
