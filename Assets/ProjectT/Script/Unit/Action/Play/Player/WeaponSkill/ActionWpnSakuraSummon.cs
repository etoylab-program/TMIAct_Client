...
public class ActionWpnSakuraSummon : ActionWeaponSkillBase
{
    private int[]               mArrMinionTableId   = new int[] { 18, 19, 20 };
    ...
    public override void Init(int tableId, List<GameTable.CharacterSkillPassive.Param> listAddCharSkillParam)
    {
        ...
        actionCommand = eActionCommand.WpnSakuraSummon;
    ...
    public override IEnumerator UpdateAction()
    {
        ...
        while (!m_endUpdate)
        {
            ...
            else if(!mbCast && m_checkTime >= m_aniCutFrameLength)
            {
                ...
                //mOwnerPlayer.ExecuteBattleOption(BattleOption.eBOTimingType.ManualCall, 0, false);
    ...
    private void StartSummon()
    {
        ...
        if (mActiveMinion)
        {
            ...
            mActiveMinion.SetInitialPosition(mOwnerPlayer.transform.position, mOwnerPlayer.transform.rotation);
